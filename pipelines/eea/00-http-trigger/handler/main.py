...
def handler(context, event):
    ...
    try:
        ...
        natura_id_field = FunctionConfig.natura_id_field
        normalized_natura2000_properties = FunctionConfig.normalized_natura2000_properties
        ...
        download_cmd = {
            ...
            "sourceID": source_id,
            "naturaIdField": natura_id_field,
            "normalizedProperties": normalized_natura2000_properties,
            "version": version}
...
class FunctionConfig(object):
    ...
    source_id = "natura2000:eea"

    natura_id_field = "SITECODE"

    normalized_natura2000_properties = dict([
        ('siteCode',{'sourceProp': 'SITECODE'}),
        ('siteName',{'sourceProp': 'SITENAME'}),
        ('releaseDate',{'sourceProp': 'RELEASE_DA'}),
        ('country',{'sourceProp': 'MS', 'evalMethod': 'lower'}),
        ('siteTypes',{
            'sourceProp': 'SITETYPE', 
            'valueMap': {
                'A': ['Special Protection Area'],
                'B': ['Special Conservation Interest'], 
                'C': ['Special Protection Areas','Special Conservation Interest']}})])
